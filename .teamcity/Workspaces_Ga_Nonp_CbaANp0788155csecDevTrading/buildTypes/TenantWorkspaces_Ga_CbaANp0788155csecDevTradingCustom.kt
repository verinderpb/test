...
object TenantWorkspaces_Ga_CbaANp0788155csecDevTradingCustom : BuildType({
    uuid = "165afc20-507d-40df-a613-2d5efbf065e1"
    extId = "TenantWorkspaces_Ga_CbaANp0788155csecDevTradingCustom"
    name = "cba-a-np-0788155-csec-dev-trading_custom"
    description = "cba-a-np-0788155-csec-dev-trading"

    params {
        param("build.vcs.number", "0788155")
    ...
    vcs {
        root("TenantWorkspaces_Ga_CustomRepos_HttpsVcsCnsgaAwsProdAuInternalCbaCbaCbaACsecTr_4", "+:.=>custom")
    ...
    triggers {
        vcs {
            triggerRules = "+:root=TenantWorkspaces_Ga_CustomRepos_HttpsVcsCnsgaAwsProdAuInternalCbaCbaCbaACsecTr_4:**"
