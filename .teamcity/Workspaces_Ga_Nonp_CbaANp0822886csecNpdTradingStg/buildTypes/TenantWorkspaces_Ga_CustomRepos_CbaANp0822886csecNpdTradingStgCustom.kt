...
object TenantWorkspaces_Ga_CustomRepos_CbaANp0822886csecNpdTradingStgCustom : BuildType({
    uuid = "ff586efa-7a0a-486d-8322-2a2f6a2200ad"
    extId = "TenantWorkspaces_Ga_CustomRepos_CbaANp0822886csecNpdTradingStgCustom"
    name = "cba-a-np-0822886-csec-npd-trading_stg_custom"
    description = "cba-a-np-0822886-csec-npd-trading_stg"

    params {
        param("build.vcs.number", "0822886")
    ...
    vcs {
        root("TenantWorkspaces_Ga_CustomRepos_HttpsVcsCnsgaAwsProdAuInternalCbaCbaCbaACsecTr_2", "+:.=>custom")
