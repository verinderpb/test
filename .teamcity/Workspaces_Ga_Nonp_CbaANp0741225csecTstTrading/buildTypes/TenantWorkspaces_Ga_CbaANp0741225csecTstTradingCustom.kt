package Workspaces_Ga_Nonp_CbaANp0741225csecTstTrading.buildTypes
...
object TenantWorkspaces_Ga_CbaANp0741225csecTstTradingCustom : BuildType({
    uuid = "21d5c64d-7d9b-44b5-918c-78aa622985a9"
    extId = "TenantWorkspaces_Ga_CbaANp0741225csecTstTradingCustom"
    name = "cba-a-np-0741225-csec-tst-trading_custom"
    description = "cba-a-np-0741225-csec-tst-trading_custom"

    params {
        param("build.vcs.number", "0741225")
    ...
    vcs {
        root("TenantWorkspaces_CbaANp0741225csecTstTrading")
        root("TenantWorkspaces_Ga_CustomRepos_HttpsVcsCnsgaAwsProdAuInternalCbaCbaCbaACsecTr_3", "+:.=>custom")
    ...
    triggers {
        vcs {
            triggerRules = "+:root=TenantWorkspaces_Ga_CustomRepos_HttpsVcsCnsgaAwsProdAuInternalCbaCbaCbaACsecTr_3:**"
