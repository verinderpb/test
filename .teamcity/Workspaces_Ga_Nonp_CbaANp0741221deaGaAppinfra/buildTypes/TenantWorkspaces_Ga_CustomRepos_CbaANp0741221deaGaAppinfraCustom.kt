package Workspaces_Ga_Nonp_CbaANp0741221deaGaAppinfra.buildTypes
...
object TenantWorkspaces_Ga_CustomRepos_CbaANp0741221deaGaAppinfraCustom : BuildType({
    uuid = "085dcbed-bf9d-45db-bd6d-033654c99ea7"
    extId = "TenantWorkspaces_Ga_CustomRepos_CbaANp0741221deaGaAppinfraCustom"
    name = "cba-a-np-0741221-dea-ga_appinfra_custom"
    description = "cba-a-np-0741221-dea-ga_appinfra_custom"


    params {
        param("build.vcs.number", "%teamcity.project.id%")
    ...
    vcs {
        root("TenantWorkspaces_Ga_CbaANp0741221deaGaAppinfra")
        root("TenantWorkspaces_Ga_CustomRepos_HttpsVcsCnsgaAwsProdAuInternalCbaCbaCbaADeaAppin", "+:.=>custom")
    ...
    triggers {
        vcs {
            triggerRules = "+:root=TenantWorkspaces_Ga_CustomRepos_HttpsVcsCnsgaAwsProdAuInternalCbaCbaCbaADeaAppin:**"
