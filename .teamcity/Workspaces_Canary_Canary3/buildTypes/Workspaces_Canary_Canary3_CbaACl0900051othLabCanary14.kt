...
object Workspaces_Canary_Canary3_CbaACl0900051othLabCanary14 : BuildType({
    uuid = "8d15decc-25bd-4dff-9119-01a0d431ab18"
    extId = "Workspaces_Canary_Canary3_CbaACl0900051othLabCanary14"
    name = "cba-a-cl-0900051-oth-lab-canary_14"
    description = "Canary3 Clab Test"

    allowExternalStatus = true
    artifactRules = """
        inventory.log
        network.log
        generate_network.log
    """.trimIndent()
    maxRunningBuilds = 1
    ...
    vcs {
        root(Workspaces_Canary_Canary3.vcsRoots.Vcs_Workspaces_Canary_Canary3_CbaACl0900051othLabCanary14)
